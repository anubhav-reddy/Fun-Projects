...
X_train, X_test, y_train, y_test = load('D:\Online COurses\Python\Data\Module6SVC\Datasets/optdigits.tes', 'D:\Online COurses\Python\Data\Module6SVC\Datasets/optdigits.tra')
...
#
guess_1000th_test_value = model.predict(X_test.iloc[999:1000,:])
...
#
fig = plt.figure()
plt.imshow(X_test.iloc[999:1000,:])
