...
X = pd.read_csv('D:\Online COurses\Python\Data\Module6SVC\Datasets/wheat.data',header = 0, index_col=0)
...
dtc = tree.DecisionTreeClassifier(max_depth=1, random_state = 2)
...
benchmark(dtc, 'DecisionTree')
drawPlots(dtc, 'DecisionTree')
