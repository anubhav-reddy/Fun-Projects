...
mat = scipy.io.loadmat('D:\Online COurses\Python\Data\Module4Isomap\Isomap\Datasets\\face_data.mat')
...
Plot2D(T, title, 1, 2, num_to_plot=40)
...
iso.fit(df)
T1 = iso.transform(df)
title = 'ISOMAP Transformation'
Plot2D(T1, title, 1, 2, num_to_plot=40)
...
Plot3D(T, title = 'PCA 3D')
Plot3D(T1, title = 'ISOMAP 3D')
plt.show()
