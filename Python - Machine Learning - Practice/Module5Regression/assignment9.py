...
# called X:
#
X = pd.read_csv('D:\Online COurses\Python\Data\Module5Regression\Datasets/College.csv', header=0, index_col= 0)
...
X_train, X_test, y_train, y_test = train_test_split(b,a,test_size=0.3,random_state=7)
...
X_train, X_test, y_train, y_test = train_test_split(c,d,test_size=0.3,random_state=7)
